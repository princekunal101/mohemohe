...
export function BookCover({
  ...
  return (
    <Link href={"/" + slug} className={cn(" relative max-w-[200px] max-h-[350px] aspect-[5/9] h-auto ")}>
      <div className={cn("min-w-[120px] max-w-[220px] aspect-[5/7] flex flex-col items-center justify-between rounded shadow-2xl bg-gradient-to-b from-rose-500 to-rose-700 text-white", {
