...
interface ChapIntroProps {
  children?: ReactNode;
  txCenter?: boolean;
  listData?: Array<{ icon: React.ReactNode; topic: React.ReactNode}>;
}
...
export function ChapIntro({
  ...
  return (<div className="not-prose my-2 md:-mx-10 md:p-10 md:my-4 md:rounded-md md:bg-secondary/60 ">
    ...
    <div className={`rounded-md border border-inherit bg-background shadow-xl px-4 py-2 dark:max-w-none ${txCenter ? "text-center" : null}`}
      {...props}>
