...
- **Dependencies:** Spring Web, Spring Data JPA, MySQL Driver, Thymeleaf, Devtools
- Click on the **generate** project button. Next, you can extract and import the downloaded ZIP file into your favorite IDE.


<FigureMdx lightUrl="java-compilation-process" desc="Project Structure"/>
...
```java title="src/main/java/com.Springboot.UserAuth.Configuration/CustomUserDetailsService.java"
...
```java title="src/main/java/com.Springboot.UserAuth.Configuration/SecurityConfig.java"
import org.springframework.beans.factory.annotation.Autowired;
...
- Open Chrome and *Enter this URL in the search bar* [localhost:8080/register](localhost:8080/register) you will see this page.
