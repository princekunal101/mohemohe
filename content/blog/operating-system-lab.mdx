...
<Callout type="warning" txCenter="true" >**Expariment 1** </Callout>
...
<Callout type="warning" txCenter="true">**Expariment 2** </Callout>
...
4. `close ()`:system call is used to close the opened file, it tells the operating system that you are done with the file and close the file.
