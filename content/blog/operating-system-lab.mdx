...
<Callout type="knowing">**Objective:** Implement the solution for Bounded Buffer (producer-consumer) problem. </Callout>
...
<Callout type="">📝**Note:** An inadequate solution could result in a deadlock where both processes are waiting to be awakened. </Callout>
...
```c title="pc_problem.c" showLineNumbers
#include <stdio.h>
void main()
{
...
```c title="first_fit.c" showLineNumbers
#include <stdio.h>
#include <process.h>
void main()
{
...
```c title="best_fit.c" showLineNumbers
#include <stdio.h>
#include <conio.h>
#define max 25
int main()
...
```c title="worst_fit.c" showLineNumbers
#include <stdio.h>
#include <stdlib.h>
int disk[20];
struct blocks
...
**See Also:** [Operating System](https:www.mohemohe.in/learn/operating-system/)
