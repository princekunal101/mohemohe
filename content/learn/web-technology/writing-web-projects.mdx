...
chapShortDesc: Developing and organizing web applications and sites using various web technologies.
chapNum: 2
...
<ChapIntro listData={[
  {icon: <Icons.PencilRuler className="w-5 h-5"/>, topic:'Strategies of choose Web Project'},
  {icon: <Icons.Globe className="w-5 h-5"/>, topic:'Internet Service and Tools'},
]}/>
