...
<ChapIntro>
<li className="flex gap-3"><Icons.Info className=" flex-shrink-0"/> Information. </li>
<hr className="my-2"/><li className="flex gap-3"><Icons.FileText className=" flex-shrink-0"/> Documents and Forms. </li>
<hr className="my-2"/><li className="flex gap-3"><Icons.SquareFunction className=" flex-shrink-0"/> Statements and Functions. </li>
<hr className="my-2"/><li className="flex gap-3"><Icons.Car className=" flex-shrink-0"/> Objects. </li>
</ChapIntro>
