...
<ChapIntro><li className="flex gap-3"><Icons.MessageSquareCode className=" flex-shrink-0"/> What is extensible markup language and its uses. </li><hr className="my-2"/><li className="flex gap-3"><Icons.Lightbulb className=" flex-shrink-0"/> Differenciate between XML and HTML. </li><hr className="my-2"/><li className="flex gap-3"><Icons.PencilRuler className=" flex-shrink-0"/> What discribe the Document Type Defination DTD.</li></ChapIntro>
...
### Difference between HDML and XML.
| HTML  | XML   |
| ----- | ----- |
