...
chapShortDesc: Structure of box element in CSS, including borders, padding, and margin.
chapNum: 8
...
<ChapIntro listData={[
  {icon: <Icons.FileCode2 className="w-5 h-5"/>, topic:' CSS property and Types of CSS.'},
  {icon: <Icons.Boxes className="w-5 h-5"/>, topic:'CSS Box Models.'}
]}/>
