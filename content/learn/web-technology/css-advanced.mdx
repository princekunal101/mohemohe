...
<ChapIntro><li className="flex gap-3"><Icons.Group className=" flex-shrink-0"/> Grouping. </li><hr className="my-2"/><li className="flex gap-3"><Icons.Info className=" flex-shrink-0"/> Types of Properties </li><hr className="my-2"/><li className="flex gap-3"><Icons.PanelTop className=" flex-shrink-0"/> Navigation bar </li></ChapIntro>
