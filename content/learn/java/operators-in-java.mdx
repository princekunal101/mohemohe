...
<NextUp nextChap="4" nextChapName="Programming Concepts in Java" nextChapLink="/java/programming-concepts"> Comming soon! {/*Let's learn about the Fundamental of Progrmming Structure. how Conditional, Looping and Branching Statements working? Basic concept of Arrays and String.  */} </NextUp>