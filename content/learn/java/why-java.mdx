...
<ChapIntro><li className="flex gap-3"><Icons.Info className=" flex-shrink-0"/> Why Java </li><hr className="my-2"/><li className="flex gap-3"><Icons.FileClock className=" flex-shrink-0"/> History of Java </li><hr className="my-2"/><li className="flex gap-3"><Icons.FilePenLine className=" flex-shrink-0"/> Java Environment and socurce File Structure </li><hr className="my-2"/><li className="flex gap-3"><Icons.FileCog className=" flex-shrink-0"/> Compilation Process </li></ChapIntro>
...
## Java Environment
Java Development Kit (JDK) includes the necessary tools to develop Java applications, such as the Java compiler `javac`, the Java Runtime Environment (JRE), and various utilities. 
